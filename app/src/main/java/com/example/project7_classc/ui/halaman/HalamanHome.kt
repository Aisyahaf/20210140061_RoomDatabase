package com.example.project7_classc.ui.halaman
...
import com.example.project7_classc.model.HomeViewModel
import com.example.project7_classc.navigasi.DestinasiNavigasi
...
fun BodyHome(
    ...
    Column (
        ...
        if (itemSiswa.isEmpty()){
            Text(
                text = stringResource(R.string.deksripsi_no_item),
